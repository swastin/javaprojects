        ...
        <form action="addEmployee" method="post">
          <div class="flex flex-col mb-5">
            ...
            <div class="relative">
              ...
              <input id="email" type="text" name="name" class="text-sm placeholder-gray-500 pl-10 pr-4 rounded-2xl border border-gray-400 w-full  py-2   focus:outline-none 
               focus:border-blue-400" placeholder="Enter your name" />
            </div>
          </div>
          <div class="flex flex-col mb-5">
          ...
          <div class="flex flex-col mb-6">
            ...
            <div class="relative">
              <div class="inline-flex items-center justify-center absolut left-0 top-0 h-full w-10 text-gray-400">
                <span>
